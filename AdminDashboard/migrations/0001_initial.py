# Generated by Django 4.2 on 2024-10-23 02:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meal_plan_person_status', models.CharField(choices=[('Corperate', 'Corperate'), ('Individual', 'Individual')], default='Individual', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cuisine_choices', models.ManyToManyField(to='AdminDashboard.cuisinechoice')),
                ('dietary_choices', models.ManyToManyField(to='AdminDashboard.dietarychoice')),
                ('friday_breakfast_dish', models.ManyToManyField(blank=True, related_name='corperate_friday_breakfast_dish', to='AdminDashboard.dishinfo')),
                ('friday_breakfast_dish_option', models.ManyToManyField(blank=True, related_name='corperate_friday_breakfast_dish_option', to='AdminDashboard.dishinfo')),
                ('friday_breakfast_meal', models.ManyToManyField(blank=True, related_name='corperate_friday_breakfast_meal', to='AdminDashboard.meal')),
                ('friday_breakfast_meal_option', models.ManyToManyField(blank=True, related_name='corperate_friday_breakfast_meal_option', to='AdminDashboard.meal')),
                ('friday_dinner_dish', models.ManyToManyField(blank=True, related_name='corperate_friday_dinner_dish', to='AdminDashboard.dishinfo')),
                ('friday_dinner_dish_option', models.ManyToManyField(blank=True, related_name='corperate_friday_dinner_dish_dish_option', to='AdminDashboard.dishinfo')),
                ('friday_dinner_meal', models.ManyToManyField(blank=True, related_name='corperate_friday_dinner_meal', to='AdminDashboard.meal')),
                ('friday_dinner_meal_option', models.ManyToManyField(blank=True, related_name='corperate_friday_dinner_meal_option', to='AdminDashboard.meal')),
                ('friday_lunch_dish', models.ManyToManyField(blank=True, related_name='corperate_friday_lunch_dish', to='AdminDashboard.dishinfo')),
                ('friday_lunch_dish_option', models.ManyToManyField(blank=True, related_name='corperate_friday_lunch_dish_option', to='AdminDashboard.dishinfo')),
                ('friday_lunch_meal', models.ManyToManyField(blank=True, related_name='corperate_friday_lunch_meal', to='AdminDashboard.meal')),
                ('friday_lunch_meal_option', models.ManyToManyField(blank=True, related_name='corperate_friday_lunch_meal_option', to='AdminDashboard.meal')),
                ('monday_breakfast_dish', models.ManyToManyField(blank=True, related_name='corperate_monday_breakfast_dish', to='AdminDashboard.dishinfo')),
                ('monday_breakfast_dish_option', models.ManyToManyField(blank=True, related_name='corperate_monday_breakfast_dish_option', to='AdminDashboard.dishinfo')),
                ('monday_breakfast_meal', models.ManyToManyField(blank=True, related_name='corperate_monday_breakfast_meal', to='AdminDashboard.meal')),
                ('monday_breakfast_meal_option', models.ManyToManyField(blank=True, related_name='corperate_monday_breakfast_meal_option', to='AdminDashboard.meal')),
                ('monday_dinner_dish', models.ManyToManyField(blank=True, related_name='corperate_monday_dinner_dish', to='AdminDashboard.dishinfo')),
                ('monday_dinner_dish_option', models.ManyToManyField(blank=True, related_name='corperate_monday_dinner_dish_option', to='AdminDashboard.dishinfo')),
                ('monday_dinner_meal', models.ManyToManyField(blank=True, related_name='corperate_monday_dinner_meal', to='AdminDashboard.meal')),
                ('monday_dinner_meal_option', models.ManyToManyField(blank=True, related_name='corperate_monday_dinner_meal_option', to='AdminDashboard.meal')),
                ('monday_lunch_dish', models.ManyToManyField(blank=True, related_name='corperate_monday_lunch_dish', to='AdminDashboard.dishinfo')),
                ('monday_lunch_dish_option', models.ManyToManyField(blank=True, related_name='corperate_monday_lunch_dish_option', to='AdminDashboard.dishinfo')),
                ('monday_lunch_meal', models.ManyToManyField(blank=True, related_name='corperate_monday_lunch_meal', to='AdminDashboard.meal')),
                ('monday_lunch_meal_option', models.ManyToManyField(blank=True, related_name='corperate_monday_lunch_meal_option', to='AdminDashboard.meal')),
                ('saturday_breakfast_dish', models.ManyToManyField(blank=True, related_name='corperate_saturday_breakfast_dish', to='AdminDashboard.dishinfo')),
                ('saturday_breakfast_dish_option', models.ManyToManyField(blank=True, related_name='corperate_saturday_breakfast_dish_option', to='AdminDashboard.dishinfo')),
                ('saturday_breakfast_meal', models.ManyToManyField(blank=True, related_name='corperate_saturday_breakfast_meal', to='AdminDashboard.meal')),
                ('saturday_breakfast_meal_option', models.ManyToManyField(blank=True, related_name='corperate_saturday_breakfast_meal_option', to='AdminDashboard.meal')),
                ('saturday_dinner_dish', models.ManyToManyField(blank=True, related_name='corperate_saturday_dinner_dish', to='AdminDashboard.dishinfo')),
                ('saturday_dinner_dish_option', models.ManyToManyField(blank=True, related_name='corperate_saturday_dinner_dish_option', to='AdminDashboard.dishinfo')),
                ('saturday_dinner_meal', models.ManyToManyField(blank=True, related_name='corperate_saturday_dinner_meal', to='AdminDashboard.meal')),
                ('saturday_dinner_meal_option', models.ManyToManyField(blank=True, related_name='corperate_saturday_dinner_meal_option', to='AdminDashboard.meal')),
                ('saturday_lunch_dish', models.ManyToManyField(blank=True, related_name='corperate_saturday_lunch_dish', to='AdminDashboard.dishinfo')),
                ('saturday_lunch_dish_option', models.ManyToManyField(blank=True, related_name='corperate_saturday_lunch_dish_option', to='AdminDashboard.dishinfo')),
                ('saturday_lunch_meal', models.ManyToManyField(blank=True, related_name='corperate_saturday_lunch_meal', to='AdminDashboard.meal')),
                ('saturday_lunch_meal_option', models.ManyToManyField(blank=True, related_name='corperate_saturday_lunch_meal_option', to='AdminDashboard.meal')),
                ('sunday_breakfast_dish', models.ManyToManyField(blank=True, related_name='corperate_sunday_breakfast_dish', to='AdminDashboard.dishinfo')),
                ('sunday_breakfast_dish_option', models.ManyToManyField(blank=True, related_name='corperate_sunday_breakfast_dish_option', to='AdminDashboard.dishinfo')),
                ('sunday_breakfast_meal', models.ManyToManyField(blank=True, related_name='corperate_sunday_breakfast_meal', to='AdminDashboard.meal')),
                ('sunday_breakfast_meal_option', models.ManyToManyField(blank=True, related_name='corperate_sunday_breakfast_meal_option', to='AdminDashboard.meal')),
                ('sunday_dinner_dish', models.ManyToManyField(blank=True, related_name='corperate_sunday_dinner_dish', to='AdminDashboard.dishinfo')),
                ('sunday_dinner_dish_option', models.ManyToManyField(blank=True, related_name='corperate_sunday_dinner_dish_option', to='AdminDashboard.dishinfo')),
                ('sunday_dinner_meal', models.ManyToManyField(blank=True, related_name='corperate_sunday_dinner_meal', to='AdminDashboard.meal')),
                ('sunday_dinner_meal_option', models.ManyToManyField(blank=True, related_name='corperate_sunday_dinner_meal_option', to='AdminDashboard.meal')),
                ('sunday_lunch_dish', models.ManyToManyField(blank=True, related_name='corperate_sunday_lunch_dish', to='AdminDashboard.dishinfo')),
                ('sunday_lunch_dish_option', models.ManyToManyField(blank=True, related_name='corperate_sunday_lunch_dish_option', to='AdminDashboard.dishinfo')),
                ('sunday_lunch_meal', models.ManyToManyField(blank=True, related_name='corperate_sunday_lunch_meal', to='AdminDashboard.meal')),
                ('sunday_lunch_meal_option', models.ManyToManyField(blank=True, related_name='corperate_sunday_lunch_meal_option', to='AdminDashboard.meal')),
                ('thursday_breakfast_dish', models.ManyToManyField(blank=True, related_name='corperate_thursday_breakfast_dish', to='AdminDashboard.dishinfo')),
                ('thursday_breakfast_dish_option', models.ManyToManyField(blank=True, related_name='corperate_thursday_breakfast_dish_option', to='AdminDashboard.dishinfo')),
                ('thursday_breakfast_meal', models.ManyToManyField(blank=True, related_name='corperate_thursday_breakfast_meal', to='AdminDashboard.meal')),
                ('thursday_breakfast_meal_option', models.ManyToManyField(blank=True, related_name='corperate_thursday_breakfast_meal_option', to='AdminDashboard.meal')),
                ('thursday_dinner_dish', models.ManyToManyField(blank=True, related_name='corperate_thursday_dinner_dish', to='AdminDashboard.dishinfo')),
                ('thursday_dinner_dish_option', models.ManyToManyField(blank=True, related_name='corperate_thursday_dinner_dish_option', to='AdminDashboard.dishinfo')),
                ('thursday_dinner_meal', models.ManyToManyField(blank=True, related_name='corperate_thursday_dinner_meal', to='AdminDashboard.meal')),
                ('thursday_dinner_meal_option', models.ManyToManyField(blank=True, related_name='corperate_thursday_dinner_meal_option', to='AdminDashboard.meal')),
                ('thursday_lunch_dish', models.ManyToManyField(blank=True, related_name='corperate_thursday_lunch_dish', to='AdminDashboard.dishinfo')),
                ('thursday_lunch_dish_option', models.ManyToManyField(blank=True, related_name='corperate_thursday_lunch_dish_option', to='AdminDashboard.dishinfo')),
                ('thursday_lunch_meal', models.ManyToManyField(blank=True, related_name='corperate_thursday_lunch_meal', to='AdminDashboard.meal')),
                ('thursday_lunch_meal_option', models.ManyToManyField(blank=True, related_name='corperate_thursday_lunch_meal_option', to='AdminDashboard.meal')),
                ('tuesday_breakfast_dish', models.ManyToManyField(blank=True, related_name='corperate_tuesday_breakfast_dish', to='AdminDashboard.dishinfo')),
                ('tuesday_breakfast_dish_option', models.ManyToManyField(blank=True, related_name='corperate_tuesday_breakfast_dish_option', to='AdminDashboard.dishinfo')),
                ('tuesday_breakfast_meal', models.ManyToManyField(blank=True, related_name='corperate_tuesday_breakfast_meal', to='AdminDashboard.meal')),
                ('tuesday_breakfast_meal_option', models.ManyToManyField(blank=True, related_name='corperate_tuesday_breakfast_meal_option', to='AdminDashboard.meal')),
                ('tuesday_dinner_dish', models.ManyToManyField(blank=True, related_name='corperate_tuesday_dinner_dish', to='AdminDashboard.dishinfo')),
                ('tuesday_dinner_dish_option', models.ManyToManyField(blank=True, related_name='corperate_tuesday_dinner_dish_option', to='AdminDashboard.dishinfo')),
                ('tuesday_dinner_meal', models.ManyToManyField(blank=True, related_name='corperate_tuesday_dinner_meal', to='AdminDashboard.meal')),
                ('tuesday_dinner_meal_option', models.ManyToManyField(blank=True, related_name='corperate_tuesday_dinner_meal_option', to='AdminDashboard.meal')),
                ('tuesday_lunch_dish', models.ManyToManyField(blank=True, related_name='corperate_tuesday_lunch_dish', to='AdminDashboard.dishinfo')),
                ('tuesday_lunch_dish_option', models.ManyToManyField(blank=True, related_name='corperate_tuesday_lunch_dish_option', to='AdminDashboard.dishinfo')),
                ('tuesday_lunch_meal', models.ManyToManyField(blank=True, related_name='corperate_tuesday_lunch_meal', to='AdminDashboard.meal')),
                ('tuesday_lunch_meal_option', models.ManyToManyField(blank=True, related_name='corperate_tuesday_lunch_meal_option', to='AdminDashboard.meal')),
                ('wednesday_breakfast_dish', models.ManyToManyField(blank=True, related_name='corperate_wednesday_breakfast_dish', to='AdminDashboard.dishinfo')),
                ('wednesday_breakfast_dish_option', models.ManyToManyField(blank=True, related_name='corperate_wednesday_breakfast_dish_option', to='AdminDashboard.dishinfo')),
                ('wednesday_breakfast_meal', models.ManyToManyField(blank=True, related_name='corperate_wednesday_breakfast_meal', to='AdminDashboard.meal')),
                ('wednesday_breakfast_meal_option', models.ManyToManyField(blank=True, related_name='corperate_wednesday_breakfast_meal_option', to='AdminDashboard.meal')),
                ('wednesday_dinner_dish', models.ManyToManyField(blank=True, related_name='corperate_wednesday_dinner_dish', to='AdminDashboard.dishinfo')),
                ('wednesday_dinner_dish_option', models.ManyToManyField(blank=True, related_name='corperate_wednesday_dinner_dish_option', to='AdminDashboard.dishinfo')),
                ('wednesday_dinner_meal', models.ManyToManyField(blank=True, related_name='corperate_wednesday_dinner_meal', to='AdminDashboard.meal')),
                ('wednesday_dinner_meal_option', models.ManyToManyField(blank=True, related_name='corperate_wednesday_dinner_meal_option', to='AdminDashboard.meal')),
                ('wednesday_lunch_dish', models.ManyToManyField(blank=True, related_name='corperate_wednesday_lunch_dish', to='AdminDashboard.dishinfo')),
                ('wednesday_lunch_dish_option', models.ManyToManyField(blank=True, related_name='corperate_wednesday_lunch_dish_option', to='AdminDashboard.dishinfo')),
                ('wednesday_lunch_meal', models.ManyToManyField(blank=True, related_name='corperate_wednesday_lunch_meal', to='AdminDashboard.meal')),
                ('wednesday_lunch_meal_option', models.ManyToManyField(blank=True, related_name='corperate_wednesday_lunch_meal_option', to='AdminDashboard.meal')),
            ],
        ),
        migrations.CreateModel(
            name='City',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='branch_info', to='account.branch')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company_info', to='account.company')),
